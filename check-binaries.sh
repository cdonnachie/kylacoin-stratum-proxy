...
echo "  Dockerfile selection: See binaries/kylacoin/DOCKERFILE-SELECTION.md"
echo ""
echo "🔨 Quick fixes for glibc issues:"
echo "  Try Debian base: cp Dockerfile.kylacoin.debian Dockerfile.kylacoin && docker-compose build kylacoin"
echo "  Try compatibility: cp Dockerfile.kylacoin.compat Dockerfile.kylacoin && docker-compose build kylacoin"